...
<section class="hero" aria-labelledby="dashboard-title">
    <div class="hero-copy-block">
        ...
        <p class="hero-copy">A vivid command center for the people behind every transaction. Browse customer records, review staff access, and see CodeIgniter MVC working in real time.</p>
    ...
    <aside class="terminal" aria-label="System summary">
        ...
        <div class="terminal-display">
            ...
            <div class="terminal-total"><strong>10</strong><span>total<br>records</span></div>
            <div class="terminal-stats">
                <div><span>Customers</span><b>05</b></div>
                <div><span>Staff users</span><b>05</b></div>
...
<section class="directory-section" aria-labelledby="directory-title">
    ...
    <a class="feature-card" href="<?= site_url('customers') ?>">
        <span class="feature-icon" aria-hidden="true">C</span><span class="card-tag">CUSTOMERS / 05</span><h3>Customer accounts</h3>
    ...
    <a class="feature-card" href="<?= site_url('users') ?>">
        <span class="feature-icon" aria-hidden="true">U</span><span class="card-tag">USERS / 05</span><h3>User accounts</h3>
        <p>Usernames, employee names, and access roles for the POS team.</p><span class="card-link">Open accounts <span aria-hidden="true">→</span></span>
    </a>
    <a class="feature-card" href="<?= site_url('about') ?>">
        <span class="feature-icon" aria-hidden="true">A</span><span class="card-tag">PROJECT / TFA1</span><h3>About this build</h3>
